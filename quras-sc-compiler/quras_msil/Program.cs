...
namespace Quras.Compiler
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            log.Log("Quras.Compiler.MSIL console app v" + Assembly.GetEntryAssembly().GetName().Version);
            if (args.Length == 0)
            {
            ...
            try
            {
                ...
                QurasModule am = conv.Convert(mod);
                bytes = am.Build();
